...
class BanglaDate
{
	...
	// "6"=>16, in June (for index 6), 1st date of corresponding bangla month is June, 16
	// "12"=>15, in December (for index 12), 1st date of corresponding bangla month is December, 15
	private $des_arr = array("1"=>14, "2"=>13, "3"=>14, "4"=>13, "5"=>14, "6"=>14, "7"=>15, "8"=>15, "9"=>15, "10"=>16, "11"=>15, "12"=>15);
	...
	function CalculateMonthAndDay()
	{
		if($this->des_arr[$this->mon] < $this->day )
		{
			...
			$this->ban_day = 	$this->day - $this->des_arr[$this->mon];
		}
		else
		{
			$tmp_mon = $this->mon-1;
			...
			$this->ban_day = 	$this->mon_end[$tmp_mon] - ($this->des_arr[$this->mon] - $this->day);
